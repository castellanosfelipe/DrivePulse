<div align="center">
  ...
  <p>
    <a href="https://github.com/castellanosfelipe/DrivePulse/releases/tag/v1.0.5"><img src="https://img.shields.io/badge/version-1.0.5-blue" alt="Versión 1.0.5"/></a>
...
La versión `1.0.5` incorpora recuperación de ACL heredadas dañadas, instalación transaccional, validación efectiva de archivos de runtime, comprobación de heartbeat y compatibilidad verificada del XML con Windows Task Scheduler. La aceptación final de tiempos de recuperación continúa pendiente en los tres equipos Windows y el NAS Synology reales.
...
- [x] Release `v1.0.5` con ZIP, instalador y checksum.
